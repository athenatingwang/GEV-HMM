...
### The code below calculates the 95% envelope of the QQ plot.
### For hourly data, this could take a while to run.
#qqhmmHr <- qq(res.hr)

### For the data we used in this study, we saved the 95% envelope 
### of the QQ plot and thus used the code below to load
...
## This gives the 95% envelope of the QQ plot.
qqhmmDay <- qq(res.day)

### Can save the results after running the code above so in the future 
### don't need to run this again. It saves time.
#save(qqhmmDay,file="../HMM-GAMgevRes/qqhmmDay.image")

### If decided to save the 95% envelope, then use this code to load it.
