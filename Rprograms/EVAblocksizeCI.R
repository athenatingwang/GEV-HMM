...
postscript("Figure 1.eps",paper="special",width=9*1.15,height=5*1.15,
...
postscript("Figure 2.eps",paper="special",width=3*2.1/1.1,
           height=10/1.1,
           onefile = TRUE, horizontal = FALSE)

par(mfrow=c(4,2))

par(mar=c(4.4,4.4,0.5,1))
...
plot(qqday$med,sort(resday),ylab="",ylim=ylims,xlab="Expected",
     cex.axis=1.5,cex.lab=1.5,pch=16,cex=0.5)
title(ylab="Observed", line=2.4, cex.lab=1.5)
...
plot(acf.day,main="",ci=0,ylim=ylims,cex.axis=1.5,cex.lab=1.5,lwd=0.6,
     xlab="Lag (day)",ylab="")
lines(acf.day.ci$low,lty=2,col="blue")
lines(acf.day.ci$upp,lty=2,col="blue")
title(ylab="ACF", line=2.4, cex.lab=1.5)
...
plot(acf.wk,main="",ci=0,ylim=ylims,cex.axis=1.5,cex.lab=1.5,lwd=0.6,
     xlab="Lag (week)",ylab="")
...
plot(acf.mth,main="",ci=0,ylim=ylims,cex.axis=1.5,cex.lab=1.5,lwd=0.6,
     xlab="Lag (month)",ylab="")
...
plot(acf.yr,main="",ci=0,ylim=ylims,cex.axis=1.5,cex.lab=1.5,lwd=0.6,
     xlab="Lag (year)",ylab="")
